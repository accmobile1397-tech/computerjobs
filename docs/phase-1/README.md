...
**Status:** ⏳ Implementation complete — awaiting CTO review (handoff via `CTO_REPORT.md`)  
**Branch:** `feature/auth`  
**Commit:** `769b6de`  
...
| File | Purpose |
|------|---------|
| [CTO_REPORT.md](./CTO_REPORT.md) | **شروع review — گزارش CTO + پیام copy-paste** |
...
🟢 Spec approved → implementation on `feature/auth` → **CTO final review** via [CTO_REPORT.md](./CTO_REPORT.md)

PR optional. See [CTO_HANDOFF.md](../reviews/CTO_HANDOFF.md).
