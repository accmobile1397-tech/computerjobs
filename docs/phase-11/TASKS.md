...
| P11-007 | Wire `/` metadata (± JSON-LD) | DONE | _(pending)_ | Org + WebSite on `/` |
...
- **Done:** 7 / 10  
- **Decision:** D-062 (P11-006 APPROVED · P11-007 authorized)  
- **Current:** P11-007 complete — **STOP** · await CTO review before P11-008
