...
import { mergeSuggestionSchema } from "@/modules/taxonomy/validators/taxonomy.schema";
...
export async function POST(
  ...
  try {
    ...
    const body = mergeSuggestionSchema.parse(await request.json());
    const suggestion = await mergeSuggestion({
      suggestionId: id,
